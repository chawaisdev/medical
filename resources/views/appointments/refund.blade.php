            ...
            <div class="card-body p-4">
                ...
                <form action="{{ route('refunds.store') }}" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="doctorFeeRefunded">
                                <i class="fa fa-user-md me-1"></i> Include Doctor's Fee ({{ number_format($discountedDoctorFee, 2) }}) in Refund
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="reason" class="form-control shadow-sm" rows="3" placeholder="Enter reason for refund request"
                            @if ($refundExists) disabled @endif></textarea>
                    </div>
